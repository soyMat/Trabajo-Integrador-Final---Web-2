        ...
        <header className="grid grid-cols-1 md:grid-cols-[1fr_2fr_1fr] items-center gap-4">
          ...
          <div className="flex justify-center w-full">
            <form className="flex w-full max-w-md rounded-full bg-black/40 border border-white/20 px-3 py-1">
              ...
              <button
                type="submit"
                className="text-sm px-2 text-gray-200"
              >
                🔍
              </button>
            </form>
          ...
          <div className="flex justify-end gap-2">
            <button
              type="button"
              className="px-3 py-1 rounded-full border border-white/20 text-xs md:text-sm hover:bg-white/10 transition"
            >
              Iniciar sesion
            </button>
            <button
        ...
        <main className="flex flex-col gap-4">
          ...
          <section className="flex flex-col gap-4 items-center text-center ">
            <div className="w-full rounded-xl overflow-hidden flex justify-center">
              <img
                src={imagenBannerPrincipal}
                alt="Promoción principal de la tienda"
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-gray-300">
                Calzado, indumentaria y accesorios.
              </p>
              <button
                type="button"
                className="px-5 py-2 rounded-full bg-white/15 hover:bg-white/25 text-sm md:text-base transition"
              >
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <article className="flex flex-col gap-3 p-3">
              ...
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <button
                  type="button"
                  className="px-4 py-2 rounded-full bg-white/15 hover:bg-white/25 text-sm transition"
                >
                  Ver categoria Hombre
                </button>
              </div>
            </article>
          ...
          <section className="rounded-2xl p-4 border border-white/15">
            <header className="mb-3">
              ...
              <p className="text-sm text-gray-300">
                Una selección de ofertas especiales.
              </p>
            </header>
            ...
            <div className="flex gap-3 overflow-x-auto pb-1">
              ...
              <article className="min-w-[220px] rounded-xl border border-white/20 bg-black/30 p-3 flex flex-col gap-2">
                <div className="h-36 rounded-lg border border-dashed border-white/25 flex items-center justify-center text-xs text-gray-300">
                  IMG
                </div>
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    type="button"
                    className="flex-1 px-3 py-1 rounded-full bg-white/10 hover:bg-white/20 text-xs transition"
                  >
                    Ver detalle
                  </button>
                  <button
                    type="button"
                    className="flex-1 px-3 py-1 rounded-full bg-white/20 hover:bg-white/30 text-xs transition"
                  >
                    Agregar al carrito
                  </button>
                </div>
        ...
        <footer className="mt-4 grid grid-cols-1 md:grid-cols-[2fr_1.2fr] gap-4 border-t border-white/10 pt-4">
          <section>
            ...
            <p className="text-sm text-gray-300 mt-1">
              Ecommerce ficticio para el Trabajo Final de Web 2. Envíos a todo el país.
            </p>
            <p className="text-sm text-gray-300">
              742 Evergreen Terrace, Springfield · Horario: lunes a lunes, 24hs.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold">Métodos de pago</h2>
            <div className="mt-2 min-h-[60px] rounded-lg border border-dashed border-white/25 flex items-center justify-center text-xs text-gray-300">
              LOGO LOOP (Visa · Master · etc.)
            </div>
          </section>
        </footer>
      </div>
